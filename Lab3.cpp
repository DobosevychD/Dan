...
int main(void){
    ...
    int size;
    //вводимо розмір множин
    printf("Input size of arrays: ");
    scanf("%d", &size);
    int array1[size];
    int array2[size];
    //вводимо елементи множини
    int i;
    for (i=0; i<size; i++)
    {
        printf("1stArray %d=", i);
